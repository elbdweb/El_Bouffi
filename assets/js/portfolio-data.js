...
const PORTFOLIO_DATA = (() => {
	...
	const competences = [
		...
		{ id_comp: 'C010', nom: 'Comptabilite generale', id_cat: 'AT02', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C011', nom: 'Comptabilite analytique', id_cat: 'AT02', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C012', nom: 'Finance internationale', id_cat: 'AT02', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C013', nom: 'Microeconomie', id_cat: 'AT01', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C014', nom: 'Macroeconomie', id_cat: 'AT01', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C015', nom: 'Economie internationale', id_cat: 'AT01', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C016', nom: 'Droit des affaires', id_cat: 'AT01', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C017', nom: 'Management des organisations', id_cat: 'AT01', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C018', nom: 'Algorithmique', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C019', nom: 'Programmation', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C020', nom: 'Python', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C021', nom: 'VBA', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C022', nom: 'JavaScript', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C023', nom: 'SAS', id_cat: 'AT03', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C024', nom: 'Systemes d\'information', id_cat: 'AT04', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C025', nom: 'Entrepot de donnees', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C026', nom: 'Big data', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C027', nom: 'Data mining', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C028', nom: 'Data visualisation', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C029', nom: 'Power BI', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C030', nom: 'Intelligence artificielle', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C031', nom: 'LLM', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C032', nom: 'Econometrie', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C033', nom: 'Series temporelles', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C034', nom: 'Prevision', id_cat: 'AT03', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C035', nom: 'Economie financiere', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C036', nom: 'Finance de marche', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C037', nom: 'Finance d\'entreprise', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C038', nom: 'Analyse financiere', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C039', nom: 'Modeles financiers', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C040', nom: 'Prevision financiere', id_cat: 'AT02', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C041', nom: 'Cybersecurite', id_cat: 'AT04', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C042', nom: 'RGPD', id_cat: 'AT04', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C043', nom: 'Droit informatique', id_cat: 'AT01', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C044', nom: 'Aide a la decision', id_cat: 'AT01', id_met: 'ME02', id_serv: 'SE01' },
		{ id_comp: 'C045', nom: 'Linux', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C046', nom: 'Reseau informatique', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C047', nom: 'Git', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C048', nom: 'PHP', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C049', nom: 'Twig', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C050', nom: 'Chart.js', id_cat: 'AT04', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C051', nom: 'SQL', id_cat: 'AT03', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C052', nom: 'MySQL', id_cat: 'AT03', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C053', nom: 'Modelisation de donnees', id_cat: 'AT03', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C054', nom: 'Historisation des donnees', id_cat: 'AT03', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C055', nom: 'Tracabilite des calculs', id_cat: 'AT03', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C056', nom: 'Kubernetes', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C057', nom: 'kubectl', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C058', nom: 'Helm', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C059', nom: 'Orchestration de conteneurs', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C060', nom: 'Deploiement applicatif', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C061', nom: 'Configuration applicative', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C062', nom: 'Persistance des donnees', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C063', nom: 'Observabilite', id_cat: 'AT05', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C064', nom: 'Allocation de couts', id_cat: 'AT02', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C065', nom: 'Amortissement', id_cat: 'AT02', id_met: 'ME01', id_serv: 'SE01' },
		{ id_comp: 'C066', nom: 'Automatisation des calculs financiers', id_cat: 'AT02', id_met: 'ME03', id_serv: 'SE02' },
		{ id_comp: 'C067', nom: 'Tableaux de bord', id_cat: 'AT01', id_met: 'ME03', id_serv: 'SE02' },
	];
